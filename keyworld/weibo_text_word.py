# -*- coding: utf-8 -*-
# !/usr/bin/env python
# @Time    : 2018/10/22 17:52
# @Author  : xhh
# @Desc    :
# @File    : weibo_text_word.py
# @Software: PyCharm
...
def handel_weibo_data():
    ...
    fp = open("file/text/gangwei.txt", 'r', encoding="utf-8")
...
def build_matrix():
    ...
    fp_textrank_result = open('file/text/result_gangwei.txt', 'w+')
    for i in range(100):
...
def post_handel_textrank():
    # 读取排名前100的词和权值
    fp_result = open('file/text/result_gangwei.txt', 'r')
    ...
    fp_result.close()
    #读取原始微博连成字符串
    fp_weibo = open('file/text/gangwei.txt', 'r')
    weibo_list = []
